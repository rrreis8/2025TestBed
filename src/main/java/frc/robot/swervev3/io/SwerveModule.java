...
import frc.robot.swervev3.io.abs.CANCoderAbsIO;
import frc.robot.swervev3.io.abs.SwerveAbsIO;
import frc.robot.swervev3.io.abs.SwerveAbsInput;
import frc.robot.swervev3.io.drive.SparkMaxDriveMotorIO;
import frc.robot.swervev3.io.drive.SwerveDriveMotorIO;
import frc.robot.swervev3.io.drive.SwerveDriveMotorInput;
...
public class SwerveModule{
    ...
    public static SwerveModule createModule(SwerveIdConfig idConf, KinematicsConversionConfig kinematicsConfig, SwervePidConfig pidConfig, ModulePosition position) {
        SparkMaxDriveMotorIO frontLeftDriveMotorIO = new SparkMaxDriveMotorIO(idConf.getDriveMotorId(), kinematicsConfig);
